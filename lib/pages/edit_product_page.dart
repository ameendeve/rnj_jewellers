...
class _EditProductPageState extends State<EditProductPage> {
  ...
  Widget _productNameInput() {
    return Padding(
      ...
      child: TextFormField(
        ...
        onSaved: (val) => _editProduct.productName = val,
  ...
  // Widget _productCategoryInput() {
  //   return Padding(
  //     padding: const EdgeInsets.only(top: 20.0),
  //     child: TextFormField(
  //       initialValue: widget.productCategory,
  //       style: TextStyle(color: Colors.white),
  //       onSaved: (val) => _editProduct.productCategory = val,
  //       decoration: InputDecoration(
  //         labelText: "Category",
              ...
              return new Container(
                ...
                child: InputDecorator(
                  ...
                  child: new DropdownButtonFormField(
                    ...
                    //validator: (value) => value == null ? 'Please select the chosen category': null,
                    isDense: true,
                    ...
                    onChanged: (String newValue) {
                      setState(() {
                        _editProduct.productCategory = newValue;
                      });
                    },
                  ),
                ),
  ...
  Widget _productDescriptionInput() {
    return Padding(
      ...
      child: TextFormField(
        ...
        style: TextStyle(color: Colors.white),
        onSaved: (val) => _editProduct.description = val,
        decoration: InputDecoration(
            border: OutlineInputBorder(),
  ...
  // Widget _productStockInput() {
  //   return Padding(
  //     padding: const EdgeInsets.only(top: 20.0),
  //     child: DropdownButtonFormField(
  //     hint: _editProduct.productStock == null
  //         ? Text('Stock Status', style: TextStyle(color: Theme.of(context).primaryColor),)
  //         : Text(
  //             _editProduct.productStock,
  //             style: TextStyle(color: Colors.white),
  //           ),
  //           value: _editProduct.productStock,
  //           validator: (value) => value == null ? 'Please enter stock status' : null,
  //     isExpanded: true,
  //     iconSize: 30.0,
  //     style: TextStyle(color: Theme.of(context).primaryColor),
  //     items: ['Available', 'Not Available'].map(
  //       (val) {
  //         return DropdownMenuItem<String>(
  //           value: val,
  //           child: Text(val),
                  ...
                  child: Column(
                    children: [
                      MultiSelectFormField(
                        ...
                        //validator: (value) => value == null || value.length == 0 ? 'Please select the chosen smith name' : null,
                        ...
                        // required: true,
                        hintWidget: Text('${widget.smithName}',
                            style: TextStyle(color: Theme.of(context).primaryColor),),
                        initialValue: res,
                        onSaved: (value) {
                          ...
                          setState(() {
                            res = value;
                            jsonRes = res.join(", ");
                            _editProduct.smithName = jsonRes;
                          });
                        },
                      ),
                      // Container(
        ...
        children: [
          Container(
            child:imageFile != null
              ...
              : widget.productImage != null ? Image.network(widget.productImage) : Center(
                    child: Container(
                              child: Card(
  ...
  _addProducts() async {
    return products.doc(widget.productId).update({
      'Product Name': _editProduct.productName,
      'Product Category': _editProduct.productCategory != null
          ? _editProduct.productCategory
          : widget.productCategory,
      'Product Description': _editProduct.description,
      'Smith Name': _editProduct.smithName.isNotEmpty ? _editProduct.smithName : widget.smithName,
      if (imageLink == null)
